...
import { ArrowLeft, Heart, Share2, Star, Truck, Shield, RefreshCw, Mail, Phone } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            <div className="aspect-square rounded-lg overflow-hidden bg-white border">
              <Image
                src={product.images[selectedImage] || '/file.svg'}
                alt={product.name}
                width={600}
                height={600}
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-2xl font-semibold text-blue-600">{formatPrice(product.price)}</span>
                {product.inStock ? (
            ...
            {/* Additional Info */}
            {(product.sku || product.product_type) && (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            {[1, 2, 3, 4].map((item) => (
              <div key={item} className="bg-white rounded-lg border p-4 hover:shadow-md transition-shadow">
                <div className="aspect-square bg-gray-100 rounded-lg mb-4"></div>                <h3 className="font-medium text-gray-900 mb-2">Related Product {item}</h3>
                <p className="text-gray-600 text-sm mb-2">Short description...</p>
                <p className="font-bold text-blue-600">Contact for pricing</p>
              </div>
            ))}
          </div>
        </div>
