...
const page = ({ params }: FeaturedProjectProps) => {
    ...
    useEffect(() => {
        const fetchProject = async () => {
            try {
                ...
                const projectData = Array.isArray(industryData.data)
                    ? industryData.data[0]
                    : industryData.data;
            ...
            <div className="min-h-screen bg-white dark:bg-slate-900">
                <div className="flex items-center justify-center min-h-screen">
                    <div className="text-center">
                        ...
                        <p className="text-lg text-slate-600 dark:text-gray-300">Loading project...</p>
                    </div>
                </div>
            </div>
        );
                    ...
                    <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
                        <div className="max-w-4xl">
                            ...
                            <nav className="flex items-center gap-3 text-sm text-white/80 mb-6">
                                ...
                                <Link href="/featured-projects" className="hover:text-white transition-colors">
                                    Featured Projects
                                </Link>
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                        ...
                                        <div className="sticky top-8 space-y-8">
                                            ...
                                            <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-6 text-white">
                                                ...
                                                <p className="text-blue-100 mb-4 text-sm">
                                                    Get in touch to discuss how we can create a custom LED display solution for your specific needs.
                                                </p>
                                                <Link
                                                    href="/contact"
                                            ...
                                            {industry.tags && industry.tags.length > 0 && (
                                                <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border border-slate-200 dark:border-slate-700">
                                                    <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-4">Project Tags</h3>
                            ...
                            <div className="bg-slate-50 dark:bg-slate-800 rounded-2xl p-8 lg:p-12 border border-slate-200 dark:border-slate-700">
                                <div className="text-center max-w-3xl mx-auto">
                                    <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">
                                        Ready to Start Your LED Display Project?
                                    </h2>
                                    <p className="text-slate-600 dark:text-gray-300 mb-8 text-lg">
                                        Our team can design and implement LED display solutions similar to this project, customized to meet your specific requirements and objectives.
                                    </p>
